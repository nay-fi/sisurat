...
<div class="card mt-4 mb-3 col-8 m-auto">
	<div class="card-body">
        ...
        <h5 class="card-title text-center fw-bolder mb-3">Update Surat Masuk</h5>

		<form method="post" action="{{ route('ops.update', $data->no_ops) }}">
			@csrf
            <div class="mb-3">
                <label for="no_ops" class="form-label">Nomor Surat Masuk</label>
                <input type="text" class="form-control" id="no_ops" name="no_ops" value="{{ $data->no_ops }}">
            </div>
			<div class="mb-3">
