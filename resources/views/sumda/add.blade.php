...
<div class="card mt-4 mb-3 col-8 m-auto">
	<div class="card-body">
		...
		<form method="post" action="{{ route('sumda.store') }}">
			@csrf
            <div class="mb-3">
                <label for="no_sumda" class="form-label">Nomor Surat Sumda</label>
                <input type="text" class="form-control" id="no_sumda" name="no_sumda">
            </div>
			<div class="mb-3">
